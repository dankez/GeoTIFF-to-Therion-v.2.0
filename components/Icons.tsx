...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({ size = 'medium', className }) => {
    ...
    return (
        <svg 
            className={`animate-spin text-white ${sizeClasses} ${className || defaultMargins}`} 
...
export const ConvertIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5M20 20v-5h-5M4 9h16v6H4V9z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M10 4l4 4-4 4M14 20l-4-4 4-4" />
    </svg>
);


export const UploadIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className || "w-8 h-8 mb-4 text-gray-500 dark:text-gray-400"} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
...
export const RestartIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-6 w-6"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5M20 20v-5h-5M4 9a9 9 0 0114.65-5.35L20 5M20 15a9 9 0 01-14.65 5.35L4 19" />
    </svg>
);
...
export const PyramidIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const LlamaHillsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className || "w-10 h-10"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 330" fill="none" stroke="currentColor" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round">
        {/* Hills: Three rounded mounds at the bottom */}
        <path d="M 10 320 Q 50 260 90 320" /> {/* Left hill */}
        <path d="M 90 320 Q 150 220 210 320" /> {/* Center hill (taller) */}
        <path d="M 210 320 Q 250 260 290 320" /> {/* Right hill */}

        {/* Llama standing on the center hill */}
        {/* Coordinates roughly based on center hill peak ~150, 220 */}
        
        {/* Back leg (left) */}
        <path d="M 125 290 L 120 240" />
        {/* Front leg (left) */}
        <path d="M 165 290 L 168 240" />
        {/* Back leg (right - hidden/behind or just parallel) */}
        <path d="M 135 285 L 130 240" /> 
        {/* Front leg (right) */}
        <path d="M 175 285 L 178 240" />
        ...
        {/* Tail */}
        <path d="M 110 210 Q 95 215 95 200 Q 95 185 110 190" />

        {/* Neck - Long and fluffy */}
        <path d="M 175 205 
                 Q 185 180 180 150 
                 Q 175 120 185 100" /> {/* Front of neck */}
        <path d="M 155 195 
                 Q 150 160 155 120" /> {/* Back of neck */}
        ...
        {/* Ears */}
        <path d="M 165 85 L 160 60 L 175 80" />
        <path d="M 185 80 L 190 55 L 195 85" />

        {/* Snout detail */}
        <path d="M 200 100 Q 205 105 200 110" />
    </svg>
);
